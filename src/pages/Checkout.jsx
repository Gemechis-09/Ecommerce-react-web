...
export default function Checkout(){
    const { getCartItemWithProduct, addToCart, removeItem, updateCartItem, getCartTotal, clearCart } = useCart();
                        ...
                        {cartItem.map((item)=>(
                            <div className="checkout-item" key={item.id}>
                                ...
                                <div className="checkout-item-controls">
                                    ...
                                    <button className="btn btn-secondary btn-small" onClick={()=>removeItem(item.id)}>Remove</button>
                                </div>
                            </div>
                        ))}
                    </div>
